...
# Plot the variogram
plot(vario, main = "Variogram of Carolina Wren Abundance")
print(vario)
```

* Is the abundance pattern isotropic or anisotropic (use variograms to support your answer)?  

THis abundance pattern seems isotropic to me. There is a steady increase in semivariacne with distance, but that last datum makes me question all of it.
